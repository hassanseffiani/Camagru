        ...
        public function index(){
            if (!is_login_in()){
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST'){
                    ...
                    else if (preg_match("/^[a-zA-Z0-9]+([._]?[a-zA-Z0-9]+)*$/" ,$data['name']) == false)
                        $data['name_err'] = 'PLease enter a valid name.';
                    else if (strlen($data['name']) <= 1)
                        $data['name_err'] = 'Enter a name should have more than 3 caractere.';
                    else if (strlen($data['name']) >= 10)
                        $data['name_err'] = 'Enter a name should have less than 11 caractere.';
                    else{
